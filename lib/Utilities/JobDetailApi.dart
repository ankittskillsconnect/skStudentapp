      ...
      try {
        ...
        if (data['status'] == true &&
          ...
          if (jobDescription.contains('<strong>Nice to Have:</strong>')) {
            final niceStart = jobDescription.indexOf('<strong>Nice to Have:</strong>') +
          ...
          // Improved location grouping
          print('🔍 Looking for job_location_detail...');
          final rawLocation = data['job_location_detail'] ?? jobDetails['job_location_detail'];
          ...
          return {
            ...
            'tags': (jobDetails['job_type'] != null ? [jobDetails['job_type']] : [])
          ...
          throw Exception('API responded with status false or job_details is null. '
